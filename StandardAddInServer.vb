...
Namespace Inventor_Tools
    <ProgIdAttribute("Inventor_Tools.StandardAddInServer"), _
    GuidAttribute("ea66f4ea-a8c3-44b1-9dd5-5358b06444fd")> _
...
#Region "Function to get the add-in client ID."
    ...
    Public Function AddInClientID() As String
        Dim guid As String = ""
        Try
            Dim t As Type = GetType(Inventor_Tools.StandardAddInServer)
